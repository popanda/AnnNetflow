...
int main(int argc, char **argv)
{
	...
	SERR << "total \tpackets: " << tcps + udps + icmps + igmps  
                                << ",\tbytes: " << tcpsb + udpsb + icmpsb + igmpsb << std::endl;
...
void sigHandler(int s)
{
	...
	{
		case SIGINT:
			SERR << "[CTRL+C]: " << std::endl;
			break;
		case SIGFPE:
			SERR << "[Bad arithmetic operation resulted in overflow]" << std::endl;
			break;
		case SIGILL:
			SERR << "[Illegal instruction detected]: " << std::endl;
			break;
		case SIGABRT:
			SERR << "[ABORT]: " << std::endl;
			break;
		case SIGSEGV:
			SERR << "[Invalid access to storage]: " << std::endl;
			break;
		case SIGTERM:
			SERR << "[Temination request was sent to the program]: " << std::endl;
			break;
	}
